        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header text-center pt-4">
                    <h5>Select Consultation Doctor For {{ $examination->user->name }}</h5>
                    <h6>Created On: {{ \Carbon\Carbon::parse($examination->created_at)->toDateString() }}</h6>
                </div>
                <div class="row">
                    @if ($errors->any())
                ...
                <div class="card-body">
                    <form role="form" action="{{ route('admin.updateexamination', $examination->id) }}" method="POST">
                        @csrf
                        @method('PUT')
