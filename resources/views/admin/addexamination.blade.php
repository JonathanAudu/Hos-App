    ...
    <div class="col-12">
        <div class="card border-0 shadow">
            <div class="card-header text-center pt-4">
                <h5>Add Examination For {{$user->name}}</h5>
            </div>
            <div class="row">
                @if ($errors->any())
            ...
            <div class="card-body">
                <form role="form" action="{{ route('admin.createexamination') }}" method="POST">
                    @csrf
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn btn-primary my-4 mb-2">Save Examination</button>
                    </div>
